...
/**
 * <p>Clase Java para Status_ReasonType.
 * 
 ...
 *     &lt;enumeration value="Pending Causal Incident Resolution"/>
 *     &lt;enumeration value="Resolved by Causal Incident"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 * 
...
public enum StatusReasonType {
    ...
    INFRASTRUCTURE_CHANGE_CREATED("Infrastructure Change Created"),
    ...
    @XmlEnumValue("Registration Approval")
    ...
    @XmlEnumValue("Third Party Vendor Action Reqd")
    THIRD_PARTY_VENDOR_ACTION_REQD("Third Party Vendor Action Reqd"),
    ...
    @XmlEnumValue("Pending Original Incident")
    PENDING_ORIGINAL_INCIDENT("Pending Original Incident"),
    @XmlEnumValue("Client Hold")
    CLIENT_HOLD("Client Hold"),
    @XmlEnumValue("Monitoring Incident")
    MONITORING_INCIDENT("Monitoring Incident"),
    @XmlEnumValue("Customer Follow-Up Required")
    CUSTOMER_FOLLOW_UP_REQUIRED("Customer Follow-Up Required"),
    @XmlEnumValue("Temporary Corrective Action")
    TEMPORARY_CORRECTIVE_ACTION("Temporary Corrective Action"),
    @XmlEnumValue("No Further Action Required")
    NO_FURTHER_ACTION_REQUIRED("No Further Action Required"),
    @XmlEnumValue("Resolved by Original Incident")
    RESOLVED_BY_ORIGINAL_INCIDENT("Resolved by Original Incident"),
    @XmlEnumValue("Automated Resolution Reported")
    AUTOMATED_RESOLUTION_REPORTED("Automated Resolution Reported"),
    @XmlEnumValue("No longer a Causal CI")
    NO_LONGER_A_CAUSAL_CI("No longer a Causal CI"),
    @XmlEnumValue("Pending Causal Incident Resolution")
    PENDING_CAUSAL_INCIDENT_RESOLUTION("Pending Causal Incident Resolution"),
    @XmlEnumValue("Resolved by Causal Incident")
    RESOLVED_BY_CAUSAL_INCIDENT("Resolved by Causal Incident");
